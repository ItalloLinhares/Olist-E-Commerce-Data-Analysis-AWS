...
def validate_geolocation(geolocation_df: DataFrame) -> DataFrame:
    ...
    valid_geolocation_records = {}
    # Validate Coordinates
    valid_geolocation_records['geolocation_lat'], invalid_geolocation_records['geolocation_lat'] = validations.validate_coordinate_format(
        geolocation_df, 'geolocation_lat'
    )

    valid_geolocation_records['geolocation_lng'], invalid_geolocation_records['geolocation_lng'] = validations.validate_coordinate_format(
        geolocation_df, 'geolocation_lng'
    )
    
    # Validate City
    #invalid_geolocation_records['geolocation_city'] = validations.validate(
    #    geolocation_df, 'geolocation_city'
    #)[1]
    
    # Validate State (UF)
    valid_geolocation_records['geolocation_state'], invalid_geolocation_records['geolocation_state'] = validations.validate_state_uf_format(
