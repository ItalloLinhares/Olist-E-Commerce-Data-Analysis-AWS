...
def validate_products(products_df: DataFrame) -> DataFrame:
    ...
    valid_products_records = {}

    # Validate ID and Category
    valid_products_records['product_id'], invalid_products_records['product_id'] = validations.validate_alphanumeric_id_32(
        products_df, 'product_id'
    )
    valid_products_records['product_category_name'], invalid_products_records['product_category_name'] = validations.validate_product_category_format(
    ...
    for col in integer_columns:
        valid_products_records[col], invalid_products_records[col] = validations.validate_integer_format(products_df, col)
